...
export const Route = createFileRoute("/assistant")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "AI Health Assistant — LifeGuard AI",
      },
      {
    ...
    >
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(0,340px)]">
        ...
        <div className="space-y-6">
          ...
          <GlassPanel className="p-6">
            <h2 className="text-lg font-bold">Voice support</h2>

            <p className="mt-2 text-sm text-muted-foreground">
              Tap the microphone to dictate a question — replies are read back
              aloud. Voice input requires a browser with the Web Speech API
              (Chrome, Edge, Safari).
            </p>
          </GlassPanel>
          ...
          <GlassPanel className="p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              The assistant provides general health guidance and explains
              health information. It does not replace professional medical
